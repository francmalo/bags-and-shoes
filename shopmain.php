                    ...
                    <div class="order-2 order-lg-1 col-lg-3 col-xl-3">
                        <div class=" shop-sidebar left-side">
                            ...
                            <div class="sidebar-widget category-widget">
                                ...
                                <ul>
                                    <li><a href="#">Woman Clothing </a> <span>(19)</span></li>
                                    <li><a href="#">Man Clothing </a> <span>(15)</span></li>
                                    <li><a href="#">Bags </a> <span>(59)</span></li>
                                    <li><a href="#">Shoes </a> <span>(29)</span></li>
                                    <li><a href="#">Man Clothing </a> <span>(56)</span></li>
                                    <li><a href="#">Woman Clothing </a> <span>(48)</span></li>
                                    <li><a href="#">Woman Clothing </a> <span>(11)</span></li>
                                </ul>
                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 col-xl-4">
                                            <div class="sin-product style-two">
                                                <div class="pro-img">
                                                    <img src="media/images/product/sp1.jpg" alt="">
                                                </div>
                                                <div class="mid-wrapper">
                                                    <h5 class="pro-title"><a href="product.html">Skater Dresses</a></h5>
                                        ...
                                        <div class="col-sm-6 col-xl-4">
                                            <div class="sin-product style-two">
                                                ...
                                                <div class="mid-wrapper">
                                                    <h5 class="pro-title"><a href="product.html">Maxi Long Dresses</a>
                                                    </h5>
                                                    <div class="color-variation">
                                                        <ul>
                                                            <li><i class="fas fa-circle"></i></li>
                                        ...
                                        <div class="col-sm-6 col-xl-4">
                                            <div class="sin-product style-two">
                                                <div class="pro-img">
                                                    <img src="media/images/product/sp3.jpg" alt="">
                                                </div>
                                                <div class="mid-wrapper">
                                                    <h5 class="pro-title"><a href="product.html">Kaftan Dresses</a></h5>
                                                    <div class="color-variation">
                                                        <ul>
                                                            <li><i class="fas fa-circle"></i></li>
                                                            <li><i class="fas fa-circle"></i></li>
                                        ...
                                        <div class="col-sm-6 col-xl-4">
                                            <div class="sin-product style-two">
                                                <div class="pro-img">
                                                    <img src="media/images/product/sp4.jpg" alt="">
                                                </div>
                                                <div class="mid-wrapper">
                                                    <h5 class="pro-title"><a href="product.html">Shirt Dresses</a></h5>
                                                    <div class="color-variation">
                                                        <ul>
                                                            <li><i class="fas fa-circle"></i></li>
                                                            <li><i class="fas fa-circle"></i></li>
                                        ...
                                        <div class="col-sm-6 col-xl-4">
                                            <div class="sin-product style-two">
                                                <div class="pro-img">
                                                    <img src="media/images/product/sp5.jpg" alt="">
                                                </div>
                                                <span class="new-tag">NEW!</span>
                                                <div class="mid-wrapper">
                                                    <h5 class="pro-title"><a href="product.html">Off Shoulder
                                                            Dresses</a></h5>
                                                    <div class="color-variation">
                                                        <ul>
                                                            <li><i class="fas fa-circle"></i></li>
                                        ...
                                        <div class="col-sm-6 col-xl-4">
                                            <div class="sin-product style-two">
                                                <div class="pro-img">
                                                    <img src="media/images/product/sp6.jpg" alt="">
                                                </div>
                                                <div class="mid-wrapper">
                                                    <h5 class="pro-title"><a href="product.html">Peplum Dresses</a></h5>
                                                    <div class="color-variation">
                                                        <ul>
                                                            <li><i class="fas fa-circle"></i></li>
                                                            <li><i class="fas fa-circle"></i></li>
                                        ...
                                        <div class="col-sm-6 col-xl-4">
                                            <div class="sin-product style-two">
                                                <div class="pro-img">
                                                    <img src="media/images/product/sp7.jpg" alt="">
                                                </div>
                                                <div class="mid-wrapper">
                                                    <h5 class="pro-title"><a href="product.html">Backless Dresses</a>
                                                    </h5>
                                                    <div class="color-variation">
                                                        <ul>
                                                            <li><i class="fas fa-circle"></i></li>
                                        ...
                                        <div class="col-sm-6 col-xl-4">
                                            <div class="sin-product style-two">
                                                ...
                                                <span class="new-tag">NEW!</span>
                                                <div class="mid-wrapper">
                                                    <h5 class="pro-title"><a href="product.html">Fringe Detail
                                                            Dresses</a></h5>
                                                    <div class="color-variation">
                                                        <ul>
                                                            <li><i class="fas fa-circle"></i></li>
                                        ...
                                        <div class="col-sm-6 col-xl-4">
                                            <div class="sin-product style-two">
                                                ...
                                                <div class="mid-wrapper">
                                                    <h5 class="pro-title"><a href="product.html">Baby Doll Dresses</a>
                                                    </h5>
                                                    <div class="color-variation">
                                                        <ul>
                                                            <li><i class="fas fa-circle"></i></li>
                                        ...
                                        <div class="col-xl-12">
                                            <div class="sin-product list-pro">
                                                <div class="row">
                                                    <div class="col-md-5 col-lg-6 col-xl-4">
                                                        <div class="pro-img">
                                                            <img src="media/images/product/lp1.jpg" alt="">
                                                        </div>
                                                        <div class="pro-icon">
                                                            <ul>
                                                                <li><a href="#"><i
                                                                ...
                                                                <li><a href="#"><i class="flaticon-compare"></i></a>
                                                                </li>
                                                                <li><a href="#" class="trigger"><i
                                                                            class="flaticon-eye"></i></a></li>
                                                            </ul>
                                                    ...
                                                    <div class="col-md-7 col-lg-6 col-xl-8">
                                                        <div class="list-pro-det">
                                                            ...
                                                            <p>Autem vel eum iriure dolor in hendrerit in vulputate
                                                                velit esse molestie consequat vel illdolore eu olestie
                                                                consequat feugiat nulla facilisis at vero eros.Autem vel
                                                                eum iriure dolor in hendrerit in vulputate velit esse
                                                                molestie consequat
                                                                vel illum dolore eu olestie consequat feugiat nulla
                                                                facilisis at vero eros.</p>
                                            ...
                                            <div class="sin-product list-pro">
                                                <div class="row">
                                                    <div class="col-md-5 col-lg-6 col-xl-4">
                                                        <div class="pro-img">
                                                            <img src="media/images/product/lp2.jpg" alt="">
                                                        </div>
                                                        <span class="new-tag">NEW!</span>
                                                        <div class="pro-icon">
                                                            <ul>
                                                    ...
                                                    <div class="col-md-7 col-lg-6 col-xl-8">
                                                        <div class="list-pro-det">
                                                            <h5 class="pro-title"><a href="product.html">Laptop carry
                                                                    bag</a></h5>
                                                            <span>$387</span>
                                                            <div class="rating">
                                                                <ul>
                                            ...
                                            <div class="sin-product list-pro">
                                                <div class="row">
                                                    <div class="col-md-5 col-lg-6 col-xl-4">
                                                        <div class="pro-img">
                                                            <img src="media/images/product/lp3.jpg" alt="">
                                                        </div>
                                                        <div class="pro-icon">
                                                            <ul>
                                                                <li><a href="#"><i
